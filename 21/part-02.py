...
def calculate_wins( p1_pos, p1_score, p2_pos, p2_score, turn ):
	p1_wins = 0
	p2_wins = 0
	...
	if turn == 0:
		for c in calculate_combinations( ):
			...
			if score >= 21:
				...
				ret_p1_wins, ret_p2_wins = calculate_wins( pos, score, p2_pos, p2_score, 1 )
		...
		for c in calculate_combinations( ):
			...
			pos = get_position( p2_pos, i, j, k )
			score = p2_score + pos

			if score >= 21:
				p2_wins += 1
			else:
				ret_p1_wins, ret_p2_wins = calculate_wins( p1_pos, p1_score, pos, score, 0 )
...
if __name__ == "__main__":
	...
	p1_wins, p2_wins = calculate_wins( player_1, 0, player_2, 0, 0 )
